-- Baseline Tables Migration
-- This migration creates all the core application tables from the Prisma baseline
...
-- CreateTable: payment_categories
...
-- CreateTable: student_payment_enrollments
